    ...
    <div class="row justify-content-center">
        <div class="col-lg-12">
            <div class="card card-outline-info">
                ...
                <div class="card-body">
                    <form action="/admin/qurbans" enctype="multipart/form-data" method="POST">
                        @csrf
                        <div class="form-body">
                            <div class="row">
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group @error('price') has-danger @enderror">
                                        ...
                                        <input type="number" id="firstName" name="price" class="form-control @error('price') form-control-danger @enderror" placeholder="Rp..." value="{{ old('price') }}">
                                        @error('price')
                                            <small class="form-control-feedback">{{$message}}</small>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group @error('weight') has-danger @enderror">
                                        ...
                                        <input type="number" id="firstName" name="weight" class="form-control @error('weight') form-control-danger @enderror" placeholder="Dalam satuan kg." value="{{ old('weight') }}">
                                        @error('weight')
                                            <small class="form-control-feedback">{{$message}}</small>
                                        @enderror
                                    </div>
